...
- [ ] Users can view a history of the last 30 export runs for each schedule, including run timestamp, status (success/failed), and delivery status
...
- [ ] Users are notified when a schedule is auto-paused due to repeated delivery failures
