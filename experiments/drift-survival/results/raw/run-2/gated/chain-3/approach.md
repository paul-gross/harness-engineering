...
Delivery Service implements automatic retry logic on delivery failures:
- Failed delivery attempts are retried automatically up to a total of 3 attempts
- After 3 failed delivery attempts, the ScheduledExport is automatically paused
