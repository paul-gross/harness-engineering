...
- [ ] A paused schedule due to delivery failure displays a failure reason to the owner
- [ ] Users can view the execution history of the last 30 export runs per schedule
- [ ] The history displays execution status (success, failed), timestamp, and delivery attempt count

### Security & Compliance
- [ ] All export events are recorded in the audit log
- [ ] All scheduled export deliveries are recorded in the audit log
- [ ] All delivery retries and failures are recorded in the audit log
...
- [ ] The feature flag can be toggled per workspace by admins
