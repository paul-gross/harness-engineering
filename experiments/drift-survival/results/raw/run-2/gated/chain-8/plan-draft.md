...
- [ ] Users can delete a scheduled export
- [ ] Scheduled exports run at defined intervals and initiate email delivery

### Delivery and Retry Logic
- [ ] Failed export deliveries are automatically retried (up to 3 attempts total)
- [ ] If delivery fails on all 3 attempts, the schedule is automatically paused with audit logging
- [ ] Users are notified of delivery failures (via in-app notification, email, or both)
