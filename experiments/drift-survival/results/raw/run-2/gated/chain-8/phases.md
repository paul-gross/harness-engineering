...
**Scope**:
- Implement the `Email Delivery Service` with retry logic (up to 3 total attempts, exponential backoff)
...
- On delivery failure, system automatically retries up to 2 more times (3 total attempts)
