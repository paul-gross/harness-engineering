...
**Scope**
- Implement Export Service contract for generating one-off exports (synchronous return of job ID)
- Implement Size Validator contract for enforcing 50 MB export limit
- Build synchronous file generation for CSV export format
...
**Acceptance Criteria**
- User can request one-off export and immediately receive job ID
...
- Implement Retry Delivery contract with attempt tracking and max-attempt limits
...
**Scope**
- Implement synchronous PDF export format alongside CSV
...
- Build end-to-end integration tests covering all four major workflows
- Performance testing for large report exports near 50 MB threshold
...
- All four workflows (one-off, schedule create, scheduled generate+deliver, pause+resume) pass integration tests
...
- Performance testing confirms large exports complete within acceptable timeframe
