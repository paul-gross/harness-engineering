...
Humans must be tightly integrated into the practice of [Harness engineering](../concepts/harness-engineering.md).  Non-deterministic LLMs [drift with high level thinking](../concepts/high-level-thinking-drift.md).
...
AI'ification when comprehension is not there seems to drift at a higher rate.  It *washes it out* with the [Average content of the internet](../concepts/average-content-of-the-internet.md).
